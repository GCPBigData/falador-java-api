...
public class KafkaConfiguration {
    ...
    KafkaReceiver kafkaReceiver() {
        ...
        configProps.put(ConsumerConfig.CLIENT_ID_CONFIG, "sisvida-client");
        configProps.put(ConsumerConfig.GROUP_ID_CONFIG, "sisvida-group-id");
